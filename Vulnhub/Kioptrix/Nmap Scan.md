# Nmap 7.94SVN scan initiated Sun Jun 15 07:42:20 2025 as: nmap -A -p- -T4 -vv -oN /home/kevin/tcm/labs/kioptrix/nmap.txt 172.16.20.131
Nmap scan report for 172.16.20.131
Host is up, received arp-response (0.00058s latency).
Scanned at 2025-06-15 07:42:20 IST for 25s
...
|_-----END CERTIFICATE-----
|_ssl-date: 2025-06-15T11:42:48+00:00; +9h30m03s from scanner time.
| http-methods: 
...
TCP/IP fingerprint:
OS:SCAN(V=7.94SVN%E=4%D=6/15%OT=22%CT=1%CU=37837%PV=Y%DS=1%DC=D%G=Y%M=000C2
OS:9%TM=684E2C1D%P=x86_64-pc-linux-gnu)SEQ(SP=CD%GCD=1%ISR=D2%TI=Z%CI=Z%II=
OS:I%TS=7)OPS(O1=M5B4ST11NW0%O2=M5B4ST11NW0%O3=M5B4NNT11NW0%O4=M5B4ST11NW0%
OS:O5=M5B4ST11NW0%O6=M5B4ST11)WIN(W1=16A0%W2=16A0%W3=16A0%W4=16A0%W5=16A0%W
OS:6=16A0)ECN(R=Y%DF=Y%T=40%W=16D0%O=M5B4NNSNW0%CC=N%Q=)T1(R=Y%DF=Y%T=40%S=
OS:O%A=S+%F=AS%RD=0%Q=)T2(R=N)T3(R=Y%DF=Y%T=40%W=16A0%S=O%A=S+%F=AS%O=M5B4S
OS:T11NW0%RD=0%Q=)T4(R=Y%DF=Y%T=FF%W=0%S=A%A=Z%F=R%O=%RD=0%Q=)T5(R=Y%DF=Y%T
OS:=FF%W=0%S=Z%A=S+%F=AR%O=%RD=0%Q=)T6(R=Y%DF=Y%T=FF%W=0%S=A%A=Z%F=R%O=%RD=
...
Uptime guess: 0.010 days (since Sun Jun 15 07:28:01 2025)
...
|   Check 2 (port 9260/tcp): CLEAN (Couldn't connect)
|   Check 3 (port 62366/udp): CLEAN (Failed to receive data)
|   Check 4 (port 47199/udp): CLEAN (Failed to receive data)
|_  0/4 checks are positive: Host is CLEAN or ports are blocked
|_clock-skew: 9h30m02s
|_smb2-time: Protocol negotiation failed (SMB2)

TRACEROUTE
HOP RTT     ADDRESS
1   0.58 ms 172.16.20.131

Read data files from: /usr/bin/../share/nmap
OS and Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Sun Jun 15 07:42:45 2025 -- 1 IP address (1 host up) scanned in 25.52 seconds
